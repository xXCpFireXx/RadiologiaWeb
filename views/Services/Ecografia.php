...
<body>
    ...
    <div class="title">
        <h1>Ecografía</h1>
        <p>La ecografía de diagnóstico, también denominada sonografía o sonografía médica de diagnóstico, es un método
            de diagnóstico por imágenes que usa ondas de sonido para producir imágenes de las estructuras dentro del
            cuerpo. Las imágenes pueden brindar información valiosa para el diagnóstico y tratamiento de diversas
            enfermedades y afecciones.</p>
    </div>
    ...
    <div class="preparaciones">
        <h4>Si desea conocer a mas a detalle las preparaciones según el tipo de ecografía, lo puede hacer a
    ...
    <div class="bibliografia">
        <h4>Bibliografia</h4>
        <cite>
            <p>Ecografía. (2022, junio 11).</p>
            Mayoclinic.org.
            <a href="https://www.mayoclinic.org/es-es/tests-procedures/ultrasound/about/pac-20395177">
                https://www.mayoclinic.org/es-es/tests-procedures/ultrasound/about/pac-20395177</a>
        </cite>
