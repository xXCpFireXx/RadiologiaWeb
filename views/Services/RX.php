...
<body>
    ...
    <div class="title">
        <h1>Rayos X Convencional</h1>
        <p>Es la prueba diagnóstica que se utiliza de forma más habitual. La radiografía utiliza los rayos X un tipo de
            radiación ionizante de alta energía que pueden traspasar el cuerpo y obtener imágenes. En el campo de la
            medicina se usa para generar imágenes de los tejidos y otras estructuras internas del cuerpo.</p>
    </div>
    ...
    <div class="preparaciones">
        <h4>Si desea conocer a mas a detalle las preparaciones según el tipo de Rayos X, lo puede hacer a
    ...
    <div class="bibliografia">
        <h4>Bibliografia</h4>
        <cite>
            <p>Radiografía Convencional. (s/f).</p>
            Clínic Barcelona. 
            <a
                href="https://www.clinicbarcelona.org/asistencia/pruebas-y-procedimientos/radiografia-convencional">
                https://www.clinicbarcelona.org/asistencia/pruebas-y-procedimientos/radiografia-convencional</a>
        </cite>
