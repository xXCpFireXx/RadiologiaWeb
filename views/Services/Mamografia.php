...
<body>
    ...
    <div class="title">
        <h1>Mamografía</h1>
        <p>La mamografía de exploración es un tipo específico de toma de imágenes de los senos que utiliza rayos X de
            baja dosis para detectar en forma temprana el cáncer (antes de que la mujer presente síntomas) cuando es más
            tratable.</p>
    </div>
    ...
    <div class="preparaciones">
        <h4>Si desea conocer a mas a detalle las preparaciones según el tipo de mamografía, lo puede hacer a
    ...
    <div class="bibliografia">
        <h4>Bibliografia</h4>
        <cite>
            <p>Radiological Society of North America (RSNA), & American College of Radiology (ACR). (s/f).</p>
            Mamografía. Radiologyinfo.org.
            <a href="https://www.radiologyinfo.org/es/info/mammo">
                https://www.radiologyinfo.org/es/info/mammo</a>
        </cite>
