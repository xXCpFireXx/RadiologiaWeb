...
<body>
    ...
    <label for="examen">Selecciona un examen:</label>
            <select id="examen" onchange="mostrarPreparacion('tomografia')">
    ...
    <div class="bibliografia">
        <h4>Bibliografia</h4>
        <cite>
            <p>Hoja informativa sobre exploraciones con tomografía computarizada (TC) para el cáncer. (2019, mayo 12).
            </p>Instituto Nacional del Cáncer. <a
                href="https://www.cancer.gov/espanol/cancer/diagnostico-estadificacion/hoja-informativa-tomografia-computarizada.">https://www.cancer.gov/espanol/cancer/diagnostico-estadificacion/hoja-informativa-tomografia-computarizada.</a>
        </cite>
    </div>
    ...
    <script src="../../php/manejoPreparaciones.js"></script>
</body>
